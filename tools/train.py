...
def parse_args():
    ...
    parser.add_argument("--config",default="configs/soft_teacher/soft_teacher_faster_rcnn_r50_caffe_fpn_coco_180k.py", help="train config file path")
    ...
    parser.add_argument(
        "--options",
        nargs="+",
        action=DictAction,  # 将参数拆分为KEY=VALUE形式，并附加到字典中
...
def main():
    ...
    meta = dict()
    # log env info
    env_info_dict = collect_env()   # 很nice 可以检测环境 之后可以参考
